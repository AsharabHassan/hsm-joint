...
export const metadata: Metadata = {
  title: "Joint Pain Treatment Glasgow | Non-Surgical Options | Harley Street Wellness",
  description:
    "Suffering from joint pain? Our Glasgow specialists offer non-surgical injection treatments for knee, hip, shoulder, and back joint pain. Free assessment. GMC-registered doctors.",
  openGraph: {
    title: "Joint Pain Treatment Glasgow | Harley Street Wellness",
    description: "Non-surgical injection treatments for joint pain. Free assessment by GMC-registered specialists at our Glasgow clinic.",
    type: "website",
  },
};
...
export default function JointPainPage() {
  return (
    <>
            ...
            <div className="hidden lg:block relative">
              ...
              >
                <img
                  ...
                  alt="Harley Street Wellness Glasgow clinic reception"
      ...
      <Quiz bodyAreaSlug="general" pageSource="glasgow-joint-pain" />
      <SocialProof />
      <PatientJourney />
