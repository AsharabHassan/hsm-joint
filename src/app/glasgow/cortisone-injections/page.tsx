...
export const metadata: Metadata = {
  title: "Cortisone & Steroid Injections Glasgow | Harley Street Wellness",
  description:
    "Cortisone and steroid injections at our Glasgow clinic. Fast-acting relief for joint pain, arthritis, and inflammation. GMC-registered specialists. Book today.",
  openGraph: {
    title: "Cortisone & Steroid Injections Glasgow | Harley Street Wellness",
    description:
      "Cortisone and steroid injections at our Glasgow clinic. Fast-acting relief for joint pain, arthritis, and inflammation.",
    type: "website",
  },
};
...
export default function CortisoneInjectionsPage() {
  return (
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-slate mb-8 leading-relaxed max-w-xl font-sans">
                Cortisone injections delivered by GMC-registered specialists at our Glasgow clinic. Relief typically begins within 48-72 hours.
              </p>
            ...
            <div className="hidden lg:block relative">
              ...
              >
                <img
                  ...
                  alt="Cortisone injection preparation at Glasgow clinic"
      ...
      <Quiz bodyAreaSlug="cortisone" pageSource="glasgow-cortisone-injections" />
      <SocialProof />
      <PatientJourney />
      <TreatmentCards bodyAreaName="Joint Pain" />
      <VideoSection
        title="Cortisone Injections: Benefits, Risks & What to Expect"
        subtitle="Our Glasgow specialists explain how cortisone works, when it's appropriate, and what the latest research says about long-term outcomes."
        topic="cortisone"
      />
      <DoctorProfiles />
      <Testimonials />
