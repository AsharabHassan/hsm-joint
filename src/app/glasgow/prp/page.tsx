...
export const metadata: Metadata = {
  title: "PRP Therapy Glasgow | Platelet-Rich Plasma Injections | Harley Street Wellness",
  description:
    "PRP (platelet-rich plasma) therapy at our Glasgow clinic. Harness your body's own healing power for joint pain, tendon injuries, and osteoarthritis. GMC-registered specialists. Book today.",
  openGraph: {
    title: "PRP Therapy Glasgow | Platelet-Rich Plasma Injections | Harley Street Wellness",
    description:
      "PRP (platelet-rich plasma) therapy at our Glasgow clinic. Expert injections using your body's own growth factors for lasting joint pain relief.",
    type: "website",
  },
};
...
export default function PRPPage() {
  return (
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-slate mb-8 leading-relaxed max-w-xl font-sans">
                Platelet-rich plasma (PRP) injections use concentrated growth factors from your own blood to stimulate natural tissue repair. Delivered by GMC-registered specialists at our Glasgow clinic.
              </p>
      ...
      <Quiz bodyAreaSlug="general" pageSource="glasgow-prp" />
      <SocialProof />
      <PatientJourney />
