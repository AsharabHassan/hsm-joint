...
export const metadata: Metadata = {
  title: "Pain Management Glasgow | Harley Street Specialists | Harley Street Wellness",
  description:
    "Expert pain management in Central Glasgow. Non-surgical injection treatments for chronic joint and muscle pain. GMC-registered specialists in Glasgow. Free assessment available.",
  openGraph: {
    title: "Pain Management Glasgow | Harley Street Wellness",
    description: "Expert pain management in Central Glasgow. Non-surgical injection treatments by GMC-registered specialists.",
    type: "website",
  },
};

export default function PainManagementGlasgowPage() {
  return (
    <>
      {/* Hero */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              <div className="inline-flex items-center gap-2.5 bg-white border border-black/[0.06] rounded-full px-4 py-2 mb-6">
                ...
                <span className="text-[12px] font-semibold text-charcoal">Ingram St, Glasgow G1</span>
              </div>
              ...
              <p className="text-lg text-slate mb-8 leading-relaxed max-w-xl font-sans">
                Struggling with chronic pain? Our Glasgow specialists use evidence-based injection therapies to help you get back to living without constant discomfort.
              </p>
      ...
      <Quiz
        ...
        pageSource="glasgow-pain-management"
        headline={
          <>
      ...
      <VideoSection
        ...
        subtitle="Our Glasgow specialists explain the evidence behind non-surgical pain management — from cortisone to advanced injection therapies."
        topic="pain-management"
      />
      <DoctorProfiles />
      <Testimonials />
      <LocationTrust location="glasgow" />
      <BottomCTA />
    </>
  );
}
