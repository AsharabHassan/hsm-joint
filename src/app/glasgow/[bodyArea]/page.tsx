...
export async function generateMetadata({
  ...
  return {
    title: `${bodyArea.headline} | Glasgow | Harley Street Wellness`,
...
export default async function BodyAreaPage({
  ...
  const breadcrumbSchema = generateBreadcrumbSchema(bodyArea.name, `/glasgow/${slug}`, "glasgow");
  ...
  return (
    <>
      ...
      />
      <Hero bodyArea={bodyArea} location="glasgow" />
      <FinancingBar />
      <Quiz bodyAreaSlug={slug} pageSource={`glasgow-${slug}`} />
      <SocialProof />
      <PatientJourney />
