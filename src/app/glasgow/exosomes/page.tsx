...
export const metadata: Metadata = {
  title: "Exosome Therapy Glasgow | Joint Treatment | Harley Street Wellness",
  description:
    "Exosome therapy for joint pain at our Glasgow clinic. Nanoscale vesicles derived from mesenchymal stem cells carrying growth factors and microRNAs to support tissue repair. GMC-registered specialists. Learn more today.",
  openGraph: {
    title: "Exosome Therapy Glasgow | Joint Treatment | Harley Street Wellness",
    description:
      "Exosome therapy for joint pain at our Glasgow clinic. Nanoscale vesicles carrying growth factors and microRNAs to support tissue repair. GMC-registered specialists.",
    type: "website",
  },
};
...
export default function ExosomesPage() {
  return (
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-slate mb-8 leading-relaxed max-w-xl font-sans">
                Exosome therapy harnesses nanoscale vesicles to support cellular communication and tissue repair. Administered by GMC-registered specialists at our Glasgow clinic, this emerging approach draws on cutting-edge regenerative science.
              </p>
      ...
      <Quiz bodyAreaSlug="general" pageSource="glasgow-exosomes" />
      <SocialProof />
      <PatientJourney />
