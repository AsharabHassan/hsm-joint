...
export const metadata: Metadata = {
  title: "Stem Cell Therapy Glasgow | Regenerative Cell Treatment | Harley Street Wellness",
  description:
    "Mesenchymal stem cell (MSC) therapy and BMAC treatment at our Glasgow clinic. Regenerative medicine using your own cells for joint pain, osteoarthritis, and cartilage repair. GMC-registered specialists. Book your assessment today.",
  openGraph: {
    title: "Stem Cell Therapy Glasgow | Regenerative Cell Treatment | Harley Street Wellness",
    description:
      "Mesenchymal stem cell (MSC) therapy and BMAC treatment at our Glasgow clinic. Regenerative medicine using your own cells for joint pain, osteoarthritis, and cartilage repair.",
    type: "website",
  },
};
...
export default function StemCellsPage() {
  return (
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              <div className="inline-flex items-center gap-2.5 bg-white border border-black/[0.06] rounded-full px-4 py-2 mb-6">
                ...
                <span className="text-[12px] text-muted">Ingram St, Glasgow</span>
              </div>
              ...
              <p className="text-lg text-slate mb-8 leading-relaxed max-w-xl font-sans">
                Mesenchymal stem cells (MSCs) harvested from your own bone marrow or adipose tissue, processed and injected by GMC-registered specialists at our Glasgow clinic. Harnessing your body&apos;s own regenerative potential to address joint pain and cartilage damage at the source.
              </p>
      ...
      <Quiz bodyAreaSlug="general" pageSource="glasgow-stem-cells" />
      <SocialProof />
      <PatientJourney />
