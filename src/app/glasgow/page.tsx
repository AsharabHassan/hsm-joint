...
export default function GlasgowHomePage() {
  const clinicSchema = generateMedicalClinicSchema("glasgow");
  ...
  return (
    <>
      ...
      <LeadCaptureForm pageSource="glasgow-home" bodyArea="glasgow-homepage" />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {bodyAreas.map((area, i) => (
              <FadeIn key={area.slug} delay={i * 80}>
                <Link href={`/glasgow/${area.slug}`} className="block group">
      ...
      <VideoSection
        ...
        subtitle="Watch our Glasgow specialists explain how modern injection therapies are helping patients avoid or delay surgery."
        topic="homepage"
      />
      <Testimonials />
